...
def _run_investigation_tui(
    *,
    ...
    """Run parallel investigation Claude calls with a Rich Live spinner.
...
def _run_first_plan(
    *,
    ...
    # _run_investigation_tui returns the InvestigationResult and a list
    # of parsed Interaction objects (one per area).
